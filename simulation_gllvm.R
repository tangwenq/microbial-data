...
sim_gllvm <- function(gllvm_m, rep_k) {
  ...
  for (k in 1:rep_k) {
    ...
    mds_ords <- fit_mds$ points # extract simluated ordinations from nMDS
    ...
    pca_ords <- fit_pca$x[, 1:2] # extract simluated ordinations from PCA
