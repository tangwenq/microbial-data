...
simulation section of the paper with the same name by Wenqi Tang, Pekka Korhonen, Jenni Niku,  Klaus Nordhausen and Sara Taskinen. It includes
...
Through the `summary()`, `AIC()` or `BIC()` functions, we can observe the AIC and BIC values
