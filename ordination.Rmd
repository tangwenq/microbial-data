---
title: "Appliying model-based unconstrained ordination methods high-dimensional compositional
  count data"
author: "wenqi tang"
date: "2025-03-03"
...
This document introduces three distinct ordination methods applicable to
high-dimensional compositional count data. Specifically, we explore
classical ordination methods, Generalized Linear Latent Variable Models
...
compositional data using the first 200 colums of microbiome data as an
...
points(pca_ords[, 1], pca_ords[, 2], col = colors[as.numeric(region_factor)], 
       pch = pch_values[as.numeric(region_factor)], cex = 1.2) 
...
From  `summary` function, we can obtain AIC and BIC shown in table 2 in thesis
...
```{r GCLVM, echo=TRUE}
 ...
 # Copula with ZINB distribution
    ...
    c_ZINB_ords <- scale(c_ZINB$scores)# extract ordinations

  
  # Copula with NB distribtuion
    c_NB <- it_copula(y, gllvm.fam = "negative.binomial", reff = "fixed", sd.errors = FALSE, seed = 123, lv.n = 0)
